...
1. 네이버 영화 리뷰
   ...
   - 텍스트 데이터 전처리
     불용어(ㅋㅋㅋ 등) 제거
     숫자 관련 데이터(15세, 19세 등)은 관람 등급에 대한 언급과 연관이 높아 보존
...
주별 평균 평점을 확인하고, loess 적합을 통해 추세를 확인하고자 하였다. 추세에 있어서는 유의미한 결과를 확인하기 어렵지만, 영화 발매 초기를 지나서는 영화의 평가에 대해 의견 차이가 벌어지는 것을 확인할 수 있다.
